            ...
            <div class="modal-body">
                <form id="ftambah" action="<?= base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="ijam_keluar">Jam Keluar *</label>
                            <div class="col-md-8">
                                <input id="ijam_keluar" name="jam_keluar" type="time" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="iarea_tujuan">Jumlah Tujuan Pengiriman *</label>
                            <div class="col-md-8">
                                <input id="iarea_tujuan" name="area_tujuan" type="number" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="idestination">Area Tujuan *</label>
                            <div class="col-md-8">
                                <input id="idestination" name="destination" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="iis_departure">Status Keberangkatan *</label>
                            <div class="col-md-8">
                                <select id="iis_departure" name="is_departure" class="form-control" required>
            ...
            <div class="modal-body">
                <form id="fedit" action="<?= base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="iejam_keluar">Jam Keluar *</label>
                            <div class="col-md-8">
                                <input id="iejam_keluar" name="jam_keluar" type="time" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="iearea_tujuan">Jumlah Tujuan Pengiriman *</label>
                            <div class="col-md-8">
                                <input id="iearea_tujuan" name="area_tujuan" type="number" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="iedestination">Area Tujuan *</label>
                            <div class="col-md-8">
                                <input id="iedestination" name="destination" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="ieis_departure">Status Keberangkatan *</label>
                            <div class="col-md-8">
                                <select id="ieis_departure" name="is_departure" class="form-control" required>
                                    <option value="0">Perjalanan</option>
                                    <option value="1">Selesai</option>
                                </select>
                            </div>
