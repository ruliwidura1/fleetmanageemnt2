...
$("#fedit").on("submit",function(e){
	...
	var url = '<?=base_url("api_admin/fleetmanagement/tujuanpengiriman/edit/".$dpm->id)?>';
	...
	$.ajax({
		...
		success: function(respon){
			if(respon.status==200){
				...
				setTimeout(function(){
					window.location = '<?=base_url_admin('fleetmanagement/tujuanpengiriman/')?>';
				},3000);
			}else{
