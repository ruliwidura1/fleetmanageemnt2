    ...
    <div class="block full row">
        ...
        <form id="ftambah" action="<?= base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-bordered form-horizontal" onsubmit="return false;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <label for="ikapasitas_angkutan" class="control-label">Kapasitas Angkutan (kg)</label>
                    <input id="ikapasitas_angkutan" type="text" class="form-control" name="kapasitas_angkutan" placeholder="Kapasitas Kendaraan" required />
                </div>
                <div class="col-md-3">
                    <label for="iavailability" class="control-label">Ketersediaan *</label>
                    <select id="iavailability" name="availability" class="form-control" required>
