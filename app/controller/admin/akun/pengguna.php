<?php
/**
 * Main Controller for `admin/akun/pengguna`
 *
 * @version 1.0.0
 *
 * @package Pengguna\Admin
 * @since 1.0.0
 */
class Pengguna extends JI_Controller
{
    ...
    private function __uploadFoto($admin_id)
    {
        ...
        $fldr = $this->config->semevar->media_pengguna;
    ...
    /**
     * Load HTML view for data `akun/pengguna`
     *
     * ```
     * GET admin/akun/pengguna/
     * ```
     *
    ...
    public function index()
    {
        ...
        $this->setTitle('Admin: Akun: Pengguna '.$this->config->semevar->site_suffix);
