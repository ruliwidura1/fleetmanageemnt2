...
class TujuanPengiriman extends \JI_Controller
{
    ...
    public function index()
    {
        ...
        $this->putThemeContent('fleetmanagement/tujuanpengiriman/home_modal', $data);
        $this->putThemeContent('fleetmanagement/tujuanpengiriman/home', $data);
        $this->putJsContent('fleetmanagement/tujuanpengiriman/home_bottom', $data);
	...
	public function baru()
	{
		...
		$this->putThemeContent("fleetmanagement/tujuanpengiriman/baru_modal",$data);
		$this->putThemeContent("fleetmanagement/tujuanpengiriman/baru",$data);
		$this->putJsContent("fleetmanagement/tujuanpengiriman/baru_bottom",$data);
		$this->loadLayout('col-2-left',$data);
		$this->render();
    }
    ...
    public function edit($id)
    {
		...
		$this->putThemeContent("fleetmanagement/tujuanpengiriman/edit_modal",$data);
		$this->putThemeContent("fleetmanagement/tujuanpengiriman/edit",$data);
		$this->putJsContent("fleetmanagement/tujuanpengiriman/edit_bottom",$data);
		$this->loadLayout('col-2-left',$data);
		$this->render();
    }
    ...
    public function detail($id){
		...
		$this->putThemeContent("fleetmanagement/tujuanpengiriman/detail",$data);
