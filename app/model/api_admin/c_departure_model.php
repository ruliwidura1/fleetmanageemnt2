 ...
 * @version 1.0.0
 *
 * @package Model\C_Departure\Api_Admin
 * @since 1.0.0
 */
class C_Departure_Model extends SENE_Model
{
    ...
    public function getAll($page = 0, $pagesize = 10, $sortCol = "id", $sortDir = "ASC", $keyword = '', $is_departure = '', $sdate = '', $edate = '')
    {
        ...
        $this->db->select_as("$this->tbl_as.jam_keluar", "jam_keluar", 0);
        $this->db->select_as("$this->tbl_as.area_tujuan", "area_tujuan", 0);
        $this->db->select_as("$this->tbl_as.destination", "destination", 0);
        $this->db->select_as("$this->tbl_as.is_departure", "is_departure", 0);
        ...
        if (strlen($is_departure)) {
            $this->db->where_as("$this->tbl_as.is_departure", $is_departure);
        }
