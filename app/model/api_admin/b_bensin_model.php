...
class B_Bensin_Model extends \Model\B_Bensin_Concern
{
    ...
    public function datatable_list($page = 0, $pagesize = 10, $sortCol = "id", $sortDir = "ASC", $keyword = '')
    {
        ...
        $this->db->select_as("$this->table_alias.tgl_beli", "tgl_beli", 0);
        $this->db->select_as("$this->table_alias.a_vehicle_id", "a_vehicle_id", 0);
        ...
        $this->db->select_as("$this->table_alias.jumlah_beli", "jumlah-beli", 0);
        $this->db->select_as("$this->table_alias.total_harga", "total_harga", 0);
        $this->db->from($this->table, $this->table_alias);
