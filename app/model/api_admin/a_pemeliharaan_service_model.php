<?php
class A_Pemeliharaan_service_model extends \Model\A_Vehicle_Concern
{
    ...
    public function getAll($page = 0, $pagesize = 10, $sortCol = "id", $sortDir = "ASC", $keyword = '', $utype = '', $sdate = '', $edate = '')
    {
        ...
        $this->db->select_as("$this->tbl_as.jadwal_pemeliharaan_rutin", "jadwal_pemeliharaan_rutin", 0);
        $this->db->select_as("$this->tbl_as.permintaan_perbaikan", "permintaan_perbaikan", 0);
        $this->db->select_as("$this->tbl_as.riwayat_perbaikan", "riwayat_perbaikan", 0);
        $this->db->select_as("$this->tbl_as.biaya_perawatan", "biaya_perawatan", 0);
        $this->db->from($this->tbl, $this->tbl_as);
